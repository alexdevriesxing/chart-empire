...
export function contentPage(path: string): string {
  const pages: Record<string, { eyebrow: string; title: string; lead: string; body: string }> = {
    "/guide": { eyebrow: "Game guide", title: "From first signing to global empire.", lead: "A practical guide to the systems that decide whether your label thrives, stalls, or runs out of cash.", body: '<img src="/images/guide_hero.png" alt="Game Guide Header" style="width:100%; border-radius: 20px; margin-bottom: 2rem; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">' + guideBody() },
    ...
    "/music-promotion": { eyebrow: "Real-world artist support", title: "Promote your music beyond the game.", lead: "Strategy starts with a strong release, clear positioning, realistic goals, and outreach that fits the artist.", body: '<img src="/images/promotion_hero.png" alt="Music Promotion Header" style="width:100%; border-radius: 20px; margin-bottom: 2rem; box-shadow: 0 10px 30px rgba(0,0,0,0.5);">' + promotionBody() },
